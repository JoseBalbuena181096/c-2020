#ifndef _ROS_ros_essentials_cpp_user_IoTSensor1_h
#define _ROS_ros_essentials_cpp_user_IoTSensor1_h
...
namespace ros_essentials_cpp_user
{
  ...
  class IoTSensor1 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ros_essentials_cpp_user/IoTSensor1"; };
