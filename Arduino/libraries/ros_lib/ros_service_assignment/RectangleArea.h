#ifndef _ROS_SERVICE_RectangleArea_h
#define _ROS_SERVICE_RectangleArea_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RECTANGLEAREA[] = "ros_service_assignment/RectangleArea";

  class RectangleAreaRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RECTANGLEAREA; };
    const char * getMD5(){ return "ed3043f094c99bdd8118bc5b0ddb14ba"; };

  };

  class RectangleAreaResponse : public ros::Msg
  {
    public:
