    ...
    */
    public:
        ...
        LineDetection():it_(nh_)
        {
            ...
            */
            Source[0]=Point2f(210*0.7,180*0.7);
            Source[1]=Point2f(430*0.7,180*0.7);
            Source[2]=Point2f(40*0.7,360*0.7);
            Source[3]=Point2f(600*0.7,360*0.7);
            //init points to desination
            Destination[0]=Point2f(170*0.7,0);
            Destination[1]=Point2f(470*0.7,0);
            Destination[2]=Point2f(170*0.7,360*0.7);
            Destination[3]=Point2f(478*0.7,360*0.7); 
	   	    distance_center = 0.0;
	        center_cam = 0;
            center_lines = 0;
		    angle = 0;
...
*/
        ...
        Mat Threshold(Mat frame)
        {
	        ...
	        width_filter(frameThreshold,17);
	    ...
	    vector<vector<PointC>> data_cluster;
            ...
            int EPSILON = 5.0;// distance for clustering
            data = non_zeros(img);
            DBCAN dbScan(60,EPSILON,MINIMUM_POINTS,data);
            dbScan.run();
