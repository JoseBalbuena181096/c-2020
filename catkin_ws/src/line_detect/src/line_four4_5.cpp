...
class LineDetection{
	...
	angle_line_pub = nh_.advertise<std_msgs::UInt8>("/angle_line_now",1000);
        ...
        Source[0]=Point2f(844*0.15,645*0.15);
        Source[1]=Point2f(1620*0.15,645*0.15);
        Source[2]=Point2f(14*0.15,1200*0.15);
        Source[3]=Point2f(2450*0.15,1200*0.15);
        //init points to desination
        Destination[0]=Point2f(834*0.15,0);
        Destination[1]=Point2f(1630*0.15,0);
        Destination[2]=Point2f(834*0.15,1440*0.15);
        Destination[3]=Point2f(1630*0.15,1440*0.15); 
	    center_cam = 0;
        center_lines = 0;
		angle = 0;
        }
